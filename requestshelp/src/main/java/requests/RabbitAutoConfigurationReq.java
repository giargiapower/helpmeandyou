...
@EnableRabbit
@Configuration
public class RabbitAutoConfigurationReq {
    ...
    @Bean
    public Queue queue2(){ return new Queue(queueName2, false);}
    @Bean
    ...
    @Bean
    public Binding secondBinding(Queue queue2, DirectExchange exchange){
